...
const BulkUploadPage = () => {
  ...
  return (
    <div className="flex flex-col p-8 min-h-1/2 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-800">
      <div className="mb-5">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex flex-col gap-6 flex-1">
              <div className="flex flex-col gap-2">
                <label htmlFor="defaultCategory" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Default Category</label>
                <select
                  id="defaultCategory"
