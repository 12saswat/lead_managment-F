      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {/* <div className="text-center mb-8 lg:mb-12">
            ...
            <p className="text-lg text-gray-600 mb-4">Advanced Lead Management System</p>
            <p className="text-sm text-gray-500 max-w-2xl mx-auto">
              Streamline your sales process by capturing and organizing potential clients with our comprehensive lead management solution. 
              Track, prioritize, and convert prospects into valuable business relationships.
            </p>
          </div> */}
                ...
                <CardContent className="space-y-3">
                  <div className="text-sm space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">Lead converted - TechCorp Inc.</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                      <span className="text-gray-600">New lead added - Healthcare Solutions</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>
                      <span className="text-gray-600">Follow-up scheduled - EduTech Pro</span>
                    </div>
                  </div>
                </CardContent>
              </Card> */}
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div>
          ...
          <CardDescription className="text-gray-600 mt-1">
            Complete the form below to add a new prospect to your sales pipeline
          </CardDescription>
        </div>
      ...
      <div className="space-y-6">
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-green-800">Lead saved successfully!</p>
              <p className="text-sm text-green-600">The form will reset automatically in 3 seconds.</p>
            </div>
          </div>
        )}
